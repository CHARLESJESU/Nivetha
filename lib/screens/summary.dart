  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue, // Ensuring blue background
        title: Text(
          'Profile Overview',
          style: TextStyle(
            fontSize: 25,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 📸 Profile Picture Review (Only for Workers)
            ...
            if (widget.userData.role == 'Worker') ...[
              ...
              SizedBox(height: 10),
              _buildInfoRow('Years of Experience:', widget.userData.experience),
            ],
